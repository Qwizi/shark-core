                    ...
                    <div className="col-md-2 col-sm-12">
                        <ul className="nav flex-md-column">
                            <li className="nav-item">
                                <a className="nav-link text-muted" href="#">Ogolnie</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link text-muted" href="#">Serwery</a>
                            </li>
                            <li className="nav-item">
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu category-1" aria-labelledby="dropdownMenuButton">
                                        <a className="dropdown-item" href="#">Jailbreak</a>
                                        <a className="dropdown-item" href="#">DeathRun</a>
                            ...
                            <div className="card card-bg">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        ...
                                        się w
                                        latach 60. XX w. wraz z publikacją arkuszy Letrasetu, zawierających fragmenty
                                        Lorem
