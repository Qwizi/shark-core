"""
Django settings for shark_coree project.
...
ROOT_URLCONF = 'shark_coree.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['/home/qwizi/Projekty/python/shark_core_project/shark_coree/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'shark_coree.wsgi.application'
