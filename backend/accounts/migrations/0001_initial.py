    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steamid3', models.CharField(blank=True, max_length=80, null=True)),
                ('display_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='auth.Group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id3', models.CharField(blank=True, max_length=80, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('wtype', models.CharField(choices=[(1, 'Primary'), (2, 'Secondary'), (3, 'Other')], default=1, max_length=64, null=True)),
                ...
                ('money', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='PLN', max_digits=14)),
